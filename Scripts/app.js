...
(function()
{
    ...
    /**
     * This method validates an input text feild in the form 
    ...
    function ValidateField(input_field_ID, regular_expression, error_message)
    {
        ...
        {
            let input_text_field = $(this).val(); // text  inside the fullname tbox
            if(!regular_expression.test(input_text_field)) // RegExp failed to validate 
            {
               // select everthing in the tbox 
               $(this).trigger("focus").trigger("select");; // go back to the field tbox
               messageArea.addClass("alert alert-danger").text(error_message).show();
            }
            else // if everthings okay 
            {
                messageArea.removeAttr("class").hide(); // removes the attribute named 
            }
        });
    }
    ...
    {
        ValidateField("fullName", /^([A-Z][a-z]{1,3}[.]?\s)([A-Z][a-z]{1,25})+(\s|,|-)([A-Z][a-z]{1,25})+(\s|,|-)*$/, "Please enter a capitalized first name followed bya capitalized last name.");
